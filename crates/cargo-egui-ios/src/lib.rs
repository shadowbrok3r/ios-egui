//! Scaffold, cross-compile, and run native egui iOS apps via xtool.
...
pub fn cmd_new(name: &str, bundle_id: Option<String>, display_name: Option<String>) -> Result<()> {
...
pub fn cmd_build(args: &BuildArgs) -> Result<PathBuf> {
