//! `cargo egui-android` — scaffold, cross-compile, and run native egui Android apps.
//!
...
fn main() -> Result<()> {
    ...
    match cli.cmd {
        ...
        Cmd::Build(a) => cmd_apk("build", &a),
        Cmd::Run(a) => cmd_apk("run", &a),
    }
}
...
fn cmd_new(name: &str, package_id: Option<String>, display_name: Option<String>) -> Result<()> {
